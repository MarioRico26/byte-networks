...
import type { SVGProps, ComponentType } from 'react' // 👈 IMPORTE CLAVE

/* ========= icon loader seguro (evita crashes si falta un ícono) ========= */
type IconComp = ComponentType<SVGProps<SVGSVGElement>> // 👈 EVITA JSX.Element
...
/* ========= Visual #2: Diagnostics mejorado (gauges circulares + sparkline) ========= */
...
const AREAS = [
    {
        ...
        desc:
            'Hardware & software troubleshooting, component replacement, OS restore, malware cleanup, and performance tuning.',
        icon: 'Laptop',
    },
    {
        id: 'cctv',
        ...
        title: 'CCTV & Cameras',
        desc:
            'Professional camera installs, clean wiring, NVR setup, secure remote access, motion alerts, and retention planning.',
        icon: 'Camera',
    },
    {
        id: 'security',
        ...
        desc:
            'Endpoint protection, firewalls, access controls, backups and recovery — practical security for peace of mind.',
        icon: 'ShieldCheck',
    },
    {
        id: 'install',
        ...
        desc:
            'Smart TVs, printers, NAS and cloud storage, tablets and peripherals — configured and ready to use.',
        icon: 'Plug',
    },
    {
        id: 'recovery',
        ...
        desc:
            'Drive diagnostics, safe recovery attempts, backup strategies and offsite retention tailored to your needs.',
        icon: 'HardDrive',
    },
    {
        id: 'diagnostics',
        ...
        desc:
            'Health checks, OS updates, cleanup, thermal refresh and preventative maintenance to keep systems fast.',
        icon: 'Gauge',
    },
] as const
                    ...
                    {AREAS.map((a, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <Link
                                    href="/#contact"
                                    className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-brand-300 hover:text-brand-2 00"
                                >
